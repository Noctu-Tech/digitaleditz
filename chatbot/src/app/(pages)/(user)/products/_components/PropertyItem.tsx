...
import { ChevronLeft, ChevronRight, Ghost, MoreVertical, PenBoxIcon, Trash2Icon } from "lucide-react"
    ...
    <Card className="flex flex-col h-[500px] w-full transition-all duration-300 hover:shadow-lg">
      ...
      <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
        ...
        <div className="relative">
         <PropertyActions propertyId={property.id} propertyName={property.title}/>
        </div>
      </CardHeader>
      ...
      <CardFooter className="pt-4">
        {property && <ViewDetailsDialog property={{ ...property, images }} />}
      </CardFooter>
    </Card>
  )
}
