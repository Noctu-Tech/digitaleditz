    ...
    <div className="h-screen  overflow-auto py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-6">
          ...
          <p className=" max-w-2xl mx-auto text-sm">Choose the perfect plan for your business needs.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6">
          {Object.values(plans).map((plan) => (
            <div 
              key={plan.id}
              className={`flex-1 border rounded-lg p-4 cursor-pointer transition-all ${selectedPlan === plan.id ? 'border-slate-900  shadow-md' : '  hover:border-slate-300'}`}
            ...
            >
              ...
              <div className="mt-3">
                <div className="text-2xl font-bold ">
                  ...
                  <span className="text-xs font-normal ">/{plan.billing}</span>
                </div>
              </div>
            </div>
          ))}
        ...
        {currentPlan.annualDiscount && (
          <div className="flex justify-center mb-6">
            <div className="inline-flex  p-1 rounded-lg">
              <button
                className={`px-3 py-1 text-sm font-medium rounded-md ${billingCycle === 'monthly' ? '  shadow-sm' : ''}`}
                onClick={() => setBillingCycle('monthly')}
              >
                Monthly Billing
              </button>
              <button
                className={`px-3 py-1 text-sm font-medium rounded-md ${billingCycle === 'annual' ? '  shadow-sm' : ''}`}
        ...
        <Card className="overflow-hidden border  shadow-lg  rounded-lg">
          <CardContent className="p-0">
            <div className="flex flex-col md:flex-row">
              {/* Plan details side */}
              <div className="flex-1  p-4 md:p-6 border-b md:border-b-0 md:border-r ">
                <h3 className="text-lg font-semibold mb-4 ">{currentPlan.name} Plan Includes</h3>
              ...
              <div className="flex-1 p-4 md:p-6 ">
                <div className=" border  rounded-lg p-4 shadow-sm">
                  <div>
                    <h3 className="text-base font-medium  mb-3">Invoice Details</h3>
                    <div className="mb-4">
                      <div className="text-2xl font-bold ">
                ...
                <div className="mt-4 space-y-3">
                  <Button className="w-full font-medium py-4 rounded-md">
